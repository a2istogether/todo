    ...
    <div className=" dark:bg-black min-h-screen ">
      ...
      {isAuthenticated ? (
        <div className="md:flex px-3">
          {<div className={`w-[300px] md:w-[250px] overflow-y-auto md:overflow-hidden pb-5 fixed top-12 mt-2 bottom-0 max-h-screen  z-[999] px-5 bg-green-200 dark:bg-green-300 duration-300 ease-in-out transition-all ${isMenuOpen?"-left-[0%]":"-left-[100%]"} md:-left-0`}>
            <Sidebar/>
          </div>}
